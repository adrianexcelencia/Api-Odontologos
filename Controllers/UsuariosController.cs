			...
			try
			{
				if (ModelState.IsValid)
				{
					using (var conexion = new SqlConnection(cadenaSQL))
					{
						...
						string insertUserQuery = "INSERT INTO Users (Username, Password, RoleID,institucionid) VALUES (@Username, @Password, @Rol,@institucionid); SELECT SCOPE_IDENTITY()";
                        ...
                        insertUserCommand.Parameters.AddWithValue("@institucionid", nuevoUsuario.RoleID);
